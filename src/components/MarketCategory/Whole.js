...
class marketCategory extends Component {
    ...
    render() {
        const CategoryList = this.state.data.map((category) => (
            <div className="col-md-3 col-lg-3 col-sm-6 my-2 text-center">
            ...
            <Container className="my-5">
                <Row>
                    <div className="col-12">
                                <h1 className={classes.category_name}>Wholesale Zone</h1>
                                <h2 className={classes.all_category}>Buy at Best Price</h2>
                    </div>
