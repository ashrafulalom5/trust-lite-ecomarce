        ...
        return (
            <CategoryLayout>
                <div className="col-12">
                                <h5 className={classes.category_name}>Homemade Ready Meals</h5>
                                <h2 className={[classes.all_category, "py-2"].join(' ')}>Browse All Category</h2>
                            </div>
