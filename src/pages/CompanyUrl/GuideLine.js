...
class GuideLine extends Component {
    ...
    render() {
        return (
            <>
                <GlobalHeader title="Guideline Information" />
                    <PageLayout>
                            <div className="bg-white">
                                <h2 className="text-dark text-center py-3 bg-light"> Guidelide Information </h2>
                                <div className="col-md-12  mr-5 p-5 col-12  info_page" >
                                    {ReactHtmlParser(this.state.update_info)}
                                </div>
                            </div>
                    </PageLayout>
                <GlobalFooter />
