...
class OrderHistory extends Component {
    ...
    componentDidMount() {
        ...
        if(token){
            ...
            Axios.post(AppUrl.CustomerPendingOrders,myFormData,config)
                .then(res=>{
            ...
            Axios.post(AppUrl.CustomerOrdersCount,myFormData,config)
                .then(res=>{
      ...
      onSuccess(event){
          ...
          Axios.post(AppUrl.CustomerSuccessOrders,myFormData,config)
              .then(res=>{
    ...
    onDelivered(event){
        ...
        Axios.post(AppUrl.CustomerDeliveredOrders,myFormData,config)
            .then(res=>{
                this.setState({records:res.data,loading:false})
                console.log(res.data+"Data Get")
            })
    ...
    onCancel(event){
        ...
        Axios.post(AppUrl.CustomerCancelOrders,myFormData,config)
            .then(res=>{
                this.setState({records:res.data,loading:false})
                console.log(res.data+"Data Get")
            })
    ...
    render() {
        ...
        return (
            <Fragment>
                <GlobalHeader title="My Order History"/>
                <Sidebar>
                    {this.state.loading==true ? <Loading/> :
                        <div className="row m-1  pt-3">
                            ...
                            <div className="col-md-12 col-12 bg-white py-3  table-responsive-sm mb-5 mt-2">
                                <h5 className="body-title pl-5"> Order History </h5>
                                <ReactDatatable
                                    config={this.config}
