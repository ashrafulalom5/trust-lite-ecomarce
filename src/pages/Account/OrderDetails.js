...
class OrderDetails extends Component {
    constructor({match}) {
        ...
        this.state={
            ...
            data:[],loading:true,type:'',p_status:'',t_status:''
        }
    }
    ...
    onReview(e){
        this.setState({review_msg:e.target.value})
    }
    ...
    onReviewsubmit(event){
        ...
        formData.append('msg',this.state.review_msg)
        if(this.state.review_msg !=""){
            Axios.post(AppUrl.ReviewMsgSend, formData)
                .then(res=>{
                    if(res.data.success){
    ...
    onFormsubmit(event){
        ...
        Axios.post(AppUrl.UpdateOrdersHistorySpm, formData)
            .then(res=>{
                if(res.data.success){
                    this.props.history.push("/spm/order-history")
                    toast.success(res.data.success, {
                        position: "top-right",
                        autoClose: 5000,
                        hideProgressBar: false,
    ...
    render() {
        ...
        return (
            <Fragment>
                <GlobalHeader title="Order History Details"/>
                <Sidebar>
                            ...
                            <div className="col-md-12" >
                                ...
                                <div className="row  mb-2 ">
                                    ...
                                    <div className="col-md-6 pl-2 p-2 mb-2  col-12 bg-white">
                                        ...
                                        <p>Service Point : {this.state.spm_location}</p>
                                ...
                                {this.state.type == "SPM" ?
                                                ...
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <select onChange={this.onTstatus.bind(this)}  className="form-control">
                                                            ...
                                                            <option value="Order procceing now"> Order procceing now </option>
                                                            <option value="Delivered"> Delivered </option>
                                                            <option value="Accepted"> Accepted </option>
                                                            <option value="Cancelled"> Cancelled </option>
                                                            <option value="Pending"> Pending </option>
                                    ...
                                    <div className="row  mb-2">
                                        <div className="bg-white col-md-11 p-5 p-2 col-12">
                                            <h3 className="text-center mb-5"> Give us your feedback  </h3>
                                            <form onSubmit={this.onReviewsubmit.bind(this)}>
                                                <div className="form-group row">
                                                    <label htmlFor="inputEmail3" className="col-sm-3 col-form-label">Message</label>
                                                    <div className="col-sm-9">
                                                        <input type="text" onChange={this.onReview.bind(this)} value={this.state.review_msg} className="form-control" id="inputEmail3"/>
                                                    </div>
                                                </div>
                                                <div className=" row">
                                                    <div className="col-sm-6">
